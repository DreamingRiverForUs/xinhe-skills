...
**中文写作补充**：中文去AI味除本skill的29条规则外，额外加载 `paper-write` skill 的 `reference/anti-aigc.md`——该文件包含针对中文学术写作的去AI化提示词（词汇规范、结构自然化、统计语义重构三大维度），尤其适合公众号文章、论文、报告等中文长文场景。

**用户中文写作偏好**：直接务实、不端着、像给朋友讲产品。厌恶营销套话（"你正在看的是..."）和推销感（"传统写论文的痛，你我都经历过"）。去掉"新范式""颠覆"等大词。口语自然。故事化开头优于观点堆砌。
...
## Chinese-Specific Anti-AIGC Patterns

When humanizing Chinese text, the 29 English patterns above still apply, but Chinese AI-generated text has additional telltale signs. See `references/chinese-anti-aigc.md` for the full Chinese-specific guide. Quick reference:

1. **万能词冗余**："进行""利用""通过...的方式" → 改为直接动词
2. **空洞修饰**："至关重要""错综复杂" → 改为具体描述
3. **套话开头**："近年来...""引起广泛关注" → 改为具体背景
4. **机械连接词**："首先其次再次最后""此外""总而言之""值得注意的是" → 去掉或改用逻辑递进
5. **被动转主动**："...被提出" → 中文学术写作习惯无主句或主动语态
6. **统计重构**：打破句长均匀性，引入低频专业词汇，重构论证路径
7. **禁止浅层伪装**：严禁仅做同义词替换或机械调换语序
